...
sed -ibackup "s|#OIDC_ENABLED#|${OIDC_ENABLED}|"                                                  app/openidm/overlays/openidm_config_map.yaml
...
sed -ibackup "s|#WELL_KNOWN_ENDPOINT#|${WELL_KNOWN_ENDPOINT}|"                                    app/openidm/overlays/openidm_config_map.yaml
...
sed -ibackup "s|#OIDC_SCOPE#|${OIDC_SCOPE}|"                                                      app/openidm/overlays/openidm_config_map.yaml
sed -ibackup "s|#OIDC_REDIRECT_URL#|${OIDC_REDIRECT_URL}|"                                        app/openidm/overlays/openidm_config_map.yaml
sed -ibackup "s|#OIDC_AUTHENTICATIONID_KEY#|${OIDC_AUTHENTICATIONID_KEY}|"                        app/openidm/overlays/openidm_config_map.yaml
sed -ibackup "s|#OIDC_PROPERTY_MAPPING#|${OIDC_PROPERTY_MAPPING}|"                                app/openidm/overlays/openidm_config_map.yaml
